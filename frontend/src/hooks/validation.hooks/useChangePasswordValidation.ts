...
const useChangePasswordValidation = () => {
  ...
  const validatePassword = (field: string, value: string, formData: any = {}, passwordField: string = "newpassword") => {
    let error = "";   
  ...
  const validatePasswordForm = (fields: { [key: string]: string }, passwordField: string = "newpassword") => {
    let valid = true;
