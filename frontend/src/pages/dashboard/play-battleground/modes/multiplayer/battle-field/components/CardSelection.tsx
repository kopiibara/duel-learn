...
const CardSelection: React.FC<CardSelectionProps> = ({
    ...
    const cards: Card[] = [
        { id: "card1", name: "STEAL!", type: "Rare Power Card", description: "Swipe a random power-up card from your opponent's hand and turn the tides in your favor." },
        { id: "card2", name: "STEAL!", type: "Rare Power Card", description: "Swipe a random power-up card from your opponent's hand and turn the tides in your favor." },
        { id: "card3", name: "STEAL!", type: "Rare Power Card", description: "Swipe a random power-up card from your opponent's hand and turn the tides in your favor." },
    ];
