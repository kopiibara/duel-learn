        ...
        {items.map((item) => (
          ...
          >
            <div className="relative">
              {/* Always show "OWNED" tag if item is owned */}
              {item.owned > 0 && (
            ...
            <div className="flex gap-2 mb-3 w-full">
              {item.owned > 0 && (
                <button className="flex-1 border rounded-lg border-[#afafaf] text-white py-2 hover:bg-[#9F87E5] focus:ring-2 focus:ring-[#9F87E5]">
                  {item.useLabel ? item.useLabel : 'Use'}
                </button>
              )}

              {item.owned < 5 && item.buyLabel && (
                <button
                  className="flex-1 border rounded-lg border-[#afafaf] text-black py-2 bg-white flex items-center justify-center hover:bg-[#e5e5e5] focus:ring-2 focus:ring-[#6F658D]"
                >
                  <span>Buy for </span>
