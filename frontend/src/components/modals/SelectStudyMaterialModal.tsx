...
const SelectStudyMaterialModal: React.FC<SelectStudyMaterialModalProps> = ({
    ...
    const studyMaterials = [
        { title: "Software Engineering", items: 50, creator: "You", date: "2024-01-01" },
        { title: "System Fundamentals", items: 10, creator: "beau.aly", date: "2023-12-01" },
        { title: "Networking Lesson 2", items: 30, creator: "kintaxx_002", date: "2023-11-01" },
        { title: "Software Engineering", items: 50, creator: "You", date: "2022-01-01" },
        { title: "System Fundamentals", items: 10, creator: "beau.aly", date: "2021-06-01" },
        { title: "Networking Lesson 2", items: 30, creator: "kintaxx_002", date: "2020-03-01" },
    ];
    ...
    const sortMaterials = (materials: any[], filter: string) => {
        switch (filter) {
            ...
            case "Oldest":
                return materials.sort((a, b) => new Date(a.date).getTime() - new Date(b.date).getTime());
            default:
                return materials;
        }
    };
                        ...
                        <Box sx={{ display: "flex", alignItems: "center", gap: 2 }}>
                            ...
                            <FormControl size="small" sx={{ minWidth: 120 }}>
                                <Select
                                    ...
                                    IconComponent={() =>
                                        openDropdown ? (
                                            <ArrowDropUpIcon sx={{ color: "#FFFFFF", marginRight: "5px" }} />
                                        ) : (
                                            <ArrowDropDownIcon sx={{ color: "#FFFFFF", marginRight: "5px" }} />
                                        )
                                    }
                                >
                            ...
                            {filteredMaterials.length > 0 ? (
                                filteredMaterials.map((material, index) => (
                                    <Button
                                        ...
                                        onClick={() => console.log(`Selected: ${material.title}`)}
                                    >
                                        <Box>
                                            <Typography
                                                variant="body1"
