...
const TermsAndConditions = () => {
  return (
    <PageTransition>
      <main className="flex overflow-hidden flex-col items-center" style={{ backgroundColor: "#080511" }}>
        {/* Main container with flexbox layout, padding, and background color */}
        <header className="flex flex-col items-start self-stretch px-16 pt-8 w-full max-md:px-5 max-md:max-w-full" style={{ backgroundColor: "rgba(59, 53, 77, 0.5)" }}>
          ...
          <div className="flex flex-wrap gap-10 w-full max-w-[1544px] max-md:max-w-full">
            ...
            <div className="flex gap-6 self-start text-2xl font-bold text-white mt-2" style={{ fontFamily: "Nunito" }}>
              ...
              />
              <h1 className="my-auto basis-auto" style={{ width: "123px", height: "33px", fontSize: "17px", fontFamily: "Nunito" }}>
              ...
              <div className="flex gap-5 max-md:flex-col">
                ...
                <div className="ml-5 w-6/12 max-md:ml-0 max-md:w-full">
                  ...
                  <img
                    ...
                    style={{ width: "345px", height: "250px", marginTop: "30px" }} // Adjusted size proportionally and moved lower
        ...
        <section className="flex flex-col items-start max-w-[936px] w-full px-4">
          ...
          <h2 className="mt-28 text-5xl font-bold text-white max-md:mt-10 max-md:max-w-full" style={{ fontSize: "48px", fontFamily: "Nunito" }}>
            {/* Heading with margin, font size, and color */}
            Terms and Conditions
          </h2>
          
          <p className="mt-4 text-2xl text-white" style={{ fontSize: "20px", fontFamily: "Nunito" }}>
            {/* Paragraph with margin, font size, and color */}
            Last Updated: 09 February 2025
          </p>

          <p className="mt-10 text-2xl text-white max-md:mt-8 max-md:max-w-full" style={{ fontSize: "20px", fontFamily: "Nunito" }}>
            {/* Paragraph with margin, font size, and color */}
            Welcome to the Duel Learn Platform. By accessing or using our platform,
            you agree to be bound by these Terms and Conditions ("Terms").
            If you do not agree with any part of these Terms, you should not use the
            platform.
          </p>
          ...
          <article className="mt-10 text-2xl text-white max-md:mt-8 max-md:max-w-full" style={{ fontSize: "20px", fontFamily: "Nunito" }}>
            ...
            <p style={{ fontSize: "20px", fontFamily: "Nunito" }}>
              By registering, accessing, or using Duel Learn, you confirm that you
              have read, understood, and agree to these Terms. If you are under the
              age of <em>[Insert Minimum Age]</em>, you must have parental or guardian 
          ...
          <article className="mt-10 text-2xl text-white max-md:mt-8 max-md:max-w-full" style={{ fontSize: "20px", fontFamily: "Nunito" }}>
            ...
            <ul className="list-disc pl-6" style={{ fontSize: "18px", fontFamily: "Nunito" }}>
              {/* Unordered list with disc style and padding */}
              <li>
                You retain ownership of the study materials and content you create.
              </li>
              <li>
              ...
              <li>
                We are not responsible for the accuracy or quality of user-generated
                content.
              </li>
            </ul>
          </article>
