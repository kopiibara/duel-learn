    ...
    return (
        <div>
            <h3 className="text-white text-2xl font-bold mb-5">
                Achievements ({achievements.filter(a => a.progress === 100).length}/{achievements.length})
            </h3>
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                {achievements.map((achievement) => (
                    ...
                    >
                        ...
                        <h4 className="text-md pt-3 pb-1 font-bold text-center">{achievement.name}</h4>
                        ...
                        <div className="flex items-center w-[85%] mt-3">
                            ...
                            <p className="text-md text-gray-300 ml-3">{calculateScale(achievement.progress)}</p>
                        </div>
                    </div>
                ))}
            </div>
