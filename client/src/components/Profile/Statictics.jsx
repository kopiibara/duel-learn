...
const Statictics = () => {
    ...
    return (
        <div>
            ...
            <div className="rounded-sm px-5 py-8 mb-10" style={{ border: "1px solid #6F658D" }}>
                <div className="grid grid-cols-3 gap-4 text-center">
                    ...
                    <div className="flex flex-col items-center gap-3 bg-transparent pr-4 relative">
                        ...
                        <h3 className="text-2xl font-bold text-white">{statistics.totalPvPMatches}</h3>
                    ...
                    <div className="flex flex-col items-center gap-3 bg-transparent pr-4 relative">
                        <div className="w-14 h-14 bg-[#D9D9D9] rounded mb-2"></div>
                        <h3 className="text-2xl font-bold text-white">{statistics.totalPvPWins}</h3>
                    ...
                    <div className="flex flex-col items-center gap-3 bg-transparent relative">
                        <div className="w-14 h-14 bg-[#D9D9D9] rounded mb-2"></div>
                        <h3 className="text-2xl font-bold text-white">{statistics.longestStreak}</h3>
