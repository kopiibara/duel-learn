...
import PremiumLabel from "../../assets/images/PremiumLabel.png";
        ...
        >
            ...
            <div className="flex-1">
                ...
                <div className="flex items-center justify-between">
                    <p className="text-[#6F658D] text-[13px] mt-1">LVL {profileData.level}</p>
                ...
                {/* Friends */}
                <p className="text-[#4D18E8] text-sm mt-2">{profileData.friendsCount} Friends</p>
            </div>
        </div>
    );
};
