...
const Leaderboards = () => {
    ...
    const [leaderboardData, setLeaderboardData] = useState([
        { rank: 1, name: "PeraltaMalakas", level: 24, xp: "1,500 XP", badge: Top1LB },
        { rank: 2, name: "CJDMarunoeng", level: 24, xp: "1,200 XP", badge: Top2LB },
        { rank: 3, name: "JingMakararig", level: 24, xp: "1,000 XP", badge: Top3LB },
